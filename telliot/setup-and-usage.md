...
Create a file named `configs/.env` \(Note: This step can be skipped if you plan to mine on a pool.\)
...
If the disputer is successful and finds a submitted value outside of your acceptable range, a text file containing pertinent information will be created in your working directory \(the one you're running the miner out of\) in the format: `"possible-dispute-(blocktime).txt"`
